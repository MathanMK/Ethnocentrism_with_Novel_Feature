    ...
    public static void writeStatsToCsvFile(String csvFilename, Simulation.RunStats[] rses) {
        ...
        for(int i=0; i<rses.length; i++) {
            ...
            { 
                ...
                String.valueOf(calculateStd(rs.sumCoopownPercent, rs.sumSqCoopownPercent, rs.runNumber)/ 10),
                String.valueOf(calculateMean(rs.sumDefotherPercent, rs.runNumber)* 10),
                String.valueOf(calculateStd(rs.sumDefotherPercent, rs.sumSqDefotherPercent, rs.runNumber) / 10),
                String.valueOf(calculateMean(rs.sumConsistEthnoPercent, rs.runNumber)* 10),
                String.valueOf(calculateStd(rs.sumConsistEthnoPercent, rs.sumSqConsistEthnoPercent, rs.runNumber) / 10),
                String.valueOf(calculateMean(rs.sumMeetownPercent, rs.runNumber)* 10),
                String.valueOf(calculateStd(rs.sumMeetownPercent, rs.sumSqMeetownPercent, rs.runNumber) / 10),
                String.valueOf(calculateMean(rs.sumCoopPercent, rs.runNumber)* 10),
                String.valueOf(calculateStd(rs.sumCoopPercent, rs.sumSqCoopPercent, rs.runNumber) / 10),
                String.valueOf(calculateMean(rs.sumLast100coopownPercent, rs.runNumber)* 10),
                String.valueOf(calculateStd(rs.sumLast100coopownPercent, rs.sumSqLast100coopownPercent, rs.runNumber)/ 10),
                String.valueOf(calculateMean(rs.sumLast100defotherPercent, rs.runNumber)* 10),
                String.valueOf(calculateStd(rs.sumLast100defotherPercent, rs.sumSqLast100defotherPercent, rs.runNumber)/ 10),
                String.valueOf(calculateMean(rs.sumLast100consistEthnoPercent, rs.runNumber)* 10),
                String.valueOf(calculateStd(rs.sumLast100consistEthnoPercent, rs.sumSqLast100consistEthnoPercent, rs.runNumber)/ 10),
                String.valueOf(calculateMean(rs.sumLast100meetownPercent, rs.runNumber)* 10),
                String.valueOf(calculateStd(rs.sumLast100meetownPercent, rs.sumSqLast100meetownPercent, rs.runNumber)/ 10),
                String.valueOf(calculateMean(rs.sumLast100coopPercent, rs.runNumber)* 10),
                String.valueOf(calculateStd(rs.sumLast100coopPercent, rs.sumSqLast100coopPercent, rs.runNumber)/ 10),
