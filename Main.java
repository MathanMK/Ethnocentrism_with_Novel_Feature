...
public class Main {
    ...
    public static void main(String [] args) {
        ...
        System.out.print("Please enter the output CSV filename (with .csv extension): ");
        String OUTPUT_CSV_FILENAME = scanner.nextLine();
        scanner.close();
    ...
    private static SimParams[] readSimParams() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(INPUT_CSV_FILENAME))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                sp.rraRadius = Integer.parseInt(record.get(col++));
